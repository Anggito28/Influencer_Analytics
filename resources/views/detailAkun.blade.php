        ...
        <div class="position-relative border-radius-xl overflow-hidden shadow-lg mb-7">
          ...
          <div class="tab-content tab-space">
            ...
            <div class="tab-pane active" id="preview-features-1">
              ...
              <iframe class="w-100 height-600" srcdoc='
...
<div class="container">
  <div class="row">
    ...
    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
          <img class="w-200 height-600" src="./style/assets/img/anya-geraldine.jpg" alt="Image placeholder">
         </div>
    </div>
    <div class="col-sm">
      <!-- <span>One of three columns</span> -->
          ...
          <div class="container border-bottom">
            <div class="row py-3">
              <div class="col-lg-4 text-start">
                <p class="lead text-dark pt-1 mb-0">Profil</p>
              </div>
      ...
      <div class="col col-lg-2">
        <div class="p-3 info-horizontal">
          ...
          <div class="description ps-3">
            <p class="mb-0"><h5>Postingan</h> <br>6.981</p>
          </div>
        </div>
      </div>
      <div class="col col-lg-2">
        <div class="p-3 info-horizontal">
          ...
          <div class="description ps-3">
            <p class="mb-0"><h5>Pengikut</h> <br>39,8 K</p>
          </div>
        </div>
      </div>
    </div>
    <div class="row justify-content-md-center">
      <div class="col col-lg-2">
        <div class="p-3 info-horizontal">
          ...
          <div class="description ps-3">
            <p class="mb-0"><h5>Age</h> <br> 12 - 25</p>
          </div>
        </div>
      </div>
      <div class="col-md-auto">
        <div class="p-3 info-horizontal">
          ...
          <div class="description ps-3">
            <p class="mb-0"><h5>Status</h> <br> Single </p>
          </div>
        </div>
      </div>
      <div class="col col-lg-2">
        <div class="p-3 info-horizontal">
          ...
          <div class="description ps-3">
            <p class="mb-0"><h5>Location</h> <br> Spain</p>
          </div>
        </div>
      </div>
    </div>
